...
from math import log # 对数函数，下文的 BM25 算法会用到
from collections import defaultdict # 特殊字典，不同字典访问不存在的 key 会报错，这个是返回 0
...
class BM25:
    ...
    def __init__(self, k1=1.5, b=0.75):
        ...
        self.avgdl = 0 # 平均文档长度
        self.idf = {} # 逆文档频率
        self.doc_freqs = defaultdict(int) # 词频统计
        self.N = 0 # 文档总数
